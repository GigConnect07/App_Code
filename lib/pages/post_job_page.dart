    ...
    if (_formKey.currentState!.validate() &&
      ...
      if (user != null) {
        try {
          ...
          print('Attempting to post job with data: $jobData');

          final docRef = await FirebaseFirestore.instance
              .collection('jobs')
              .add(jobData);
          print('Job posted successfully with ID: ${docRef.id}');
          ...
          child: ListView(
            children: [
              ...
              DropdownButtonFormField(
                ...
                onChanged:
                    (value) => setState(() => jobType = value.toString()),
              ...
              TextFormField(
                ...
                validator:
                    (value) => value!.isEmpty ? 'Enter job location' : null,
              ),
                ...
                children: [
                  Expanded(
                    child: TextFormField(
                      ...
                      validator:
                          (value) =>
                              value!.isEmpty ? 'Enter minimum rate' : null,
                    ),
                  ),
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      validator:
                          (value) =>
                              value!.isEmpty ? 'Enter maximum rate' : null,
                    ),
                  ),
                ],
              ),
              ...
              TextFormField(
                ...
                validator:
                    (value) => value!.isEmpty ? 'Enter job description' : null,
              ),
              TextFormField(
              ...
              DropdownButtonFormField(
                ...
                items: const [
                  DropdownMenuItem(
                    value: 'entry',
                    child: Text('Entry Level (0-2 years)'),
                  ),
                  DropdownMenuItem(
                    value: 'intermediate',
                    child: Text('Intermediate (3-5 years)'),
                  ),
                  DropdownMenuItem(
                    value: 'experienced',
                    child: Text('Experienced (5-10 years)'),
                  ),
                  DropdownMenuItem(
                    value: 'expert',
                    child: Text('Expert (10+ years)'),
                  ),
                ],
                onChanged:
                    (value) =>
                        setState(() => experienceLevel = value.toString()),
                validator:
                    (value) => value == null ? 'Select experience level' : null,
              ),
              const SizedBox(height: 20),
              const Text(
                "Project Timeline",
              ...
              DropdownButtonFormField(
                ...
                onChanged:
                    (value) => setState(() => duration = value.toString()),
                validator:
                    (value) => value == null ? 'Select project duration' : null,
              ),
