...
class JobApplicationsPage extends StatelessWidget {
  ...
  Future<void> _updateApplicationStatus(String applicantId, String newStatus) async {
    try {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return JobApplicationCard(
                ...
                skills: skills,
                status: status,
                onAccept: () => _updateApplicationStatus(applicantId, 'accepted'),
                onReject: () => _updateApplicationStatus(applicantId, 'rejected'),
              );
            },
          );
        },
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Text('Applied: ${applicant['dateApplied'] ?? 'N/A'}'),
            Text(
              _getStatusText(),
        ...
        trailing: Column(
          ...
          children: [
            ...
            if (status == 'pending') ...[
              IconButton(icon: const Icon(Icons.check_circle, color: Colors.green), onPressed: onAccept),
